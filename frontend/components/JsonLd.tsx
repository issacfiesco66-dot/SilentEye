...
export const serviceJsonLd = {
  ...
  serviceType: 'Rastreo satelital y GPS vehicular',
  keywords: [
    'rastreo satelital para camiones',
    'rastreo satelital de vehículos',
    'rastreo satelital para camiones de carga',
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Rastreo satelital para camiones, trailers y tractocamión',
          description: 'Rastreo satelital y GPS industrial para transporte de carga: monitoreo en carretera 24/7, alertas de desvío de ruta, botón de pánico físico para el conductor y coordinación de recuperación. Compatible con Teltonika FMC130, Queclink GV500 y Concox GT06N.',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Service',
          name: 'Rastreo satelital de flotas de camiones',
          description: 'Monitoreo satelital multi-vehículo para flotas de transporte: panel unificado, asignación de conductores, geocercas por zona de carga/descarga, reportes PDF de incidentes y alertas de velocidad. Desde $79 MXN/mes por vehículo.',
        },
      },
      {
        '@type': 'Offer',
